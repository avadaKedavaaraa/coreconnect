...
import { 
  ...
  Monitor, Smartphone, PenTool, Save, Trash2, AlignJustify
} from 'lucide-react';
    ...
    `}>
      ...
      >
        ...
        <div className="flex-1 flex flex-col relative min-w-0">
            ...
            {/* Toolbar */}
            <div className={`p-2 border-b flex flex-wrap items-center justify-between gap-2 shrink-0 z-20
                    ...
                    <div className="min-w-0">
                        ...
                        <div className="flex gap-2 text-[10px] mt-0.5">
                            ...
                            <button 
                                ...
                                className={`flex items-center gap-1 hover:underline ${engine === 'google' ? 'opacity-100 font-bold' : 'opacity-50'}`}
                            >
            ...
            <div 
                ref={containerRef}
                className="flex-1 bg-zinc-900 relative w-full overflow-hidden flex items-center justify-center"
                onMouseMove={handleMouseMove}
            >
                {/* Visual Filter Layer */}
                <div 
                    className="w-full h-full transition-all duration-300 origin-center relative z-10"
                    style={{ 
                ...
                {showRuler && (
                    <div 
                        ref={rulerRef}
                        className={`absolute left-0 right-0 h-8 pointer-events-none z-20 mix-blend-difference opacity-50
