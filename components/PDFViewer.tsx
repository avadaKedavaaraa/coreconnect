...
import { 
  ...
  Monitor, Smartphone, PenTool, Save, Trash2, AlignJustify, Loader2
} from 'lucide-react';
...
const PDFViewer: React.FC<PDFViewerProps> = ({ item, lineage, onClose }) => {
  ...
  const isDrive = safePdfUrl.includes('drive.google.com');
                ...
                <div className="flex items-center gap-3 min-w-0 max-w-[40%]">
                    ...
                    <div className="min-w-0">
                        ...
                        <div className="flex gap-2 text-[10px] mt-0.5">
                            ...
                            {!isDrive && <span className="opacity-30">|</span>}
                            <button 
                                onClick={() => { setEngine('google'); setIsLoading(true); }} 
                                className={`flex items-center gap-1 hover:underline ${engine === 'google' || isDrive ? 'opacity-100 font-bold' : 'opacity-50'}`}
                            >
