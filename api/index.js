...
router.post('/admin/drive-scan', requireAuth, async (req, res) => {
    ...
    try {
        ...
        // 👇 UPDATED QUERY: Removed "mimeType='application/pdf'" restriction
        ...
        const newItems = files.map(file => ({
            ...
            // 👇 UPDATED TITLE CLEANER: Removes .pptx, .xlsx, .docx, etc.
            title: file.name.replace(/\.(pdf|docx?|xlsx?|pptx?|txt|csv)$/i, ''),
